### Installation
```
git clone https://github.com/blonder413/blonder413
...
Revisar la carpeta rbac en la raíz, contiene las reglas de validación para el seeder RBAC
...
- https://github.com/kartik-v/yii2-widget-select2 (https://github.com/kartik-v/yii2-widget-select2)
...
- CKEditor Расширение для Yii 2 (https://www.yiiframework.com/extension/mihaildev/yii2-ckeditor)
