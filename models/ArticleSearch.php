...
class ArticleSearch extends Article
{
    ...
    {
        return [
            [['id', 'number', 'type_id', 'category_id', 'visit_counter', 'download_counter', 'course_id'], 'integer'],
            [['title', 'slug', 'topic', 'detail', 'abstract', 'video', 'download', 'tags', 'status', 'created_by', 'updated_by', 'created_at', 'updated_at'], 'safe'],
        ];
    }
    /**
     * @inheritdoc
