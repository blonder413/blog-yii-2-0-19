...
//            OptimisticLockBehavior::className(),
     ...
     * 2. Ensure the version value is submitted and loaded to your model before any update or delete. Or add OptimisticLockBehavior to your parent model class in order to automate the process.
